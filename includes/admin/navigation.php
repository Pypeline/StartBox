		...
		$this->options = array(
			...
			'footer_nav' => array(
					...
					'position'	=> apply_filters( 'sb_footer_nav_position', array(
						'between_content_and_footer'	=> __( 'Before Footer Wrap', 'startbox' ),
						'before_footer'	=> __( 'Before Footer Widgets', 'startbox' ),
						'footer'			=> __( 'After Footer Widgets', 'startbox' ),
						'footer_left'	=> __( 'Footer Left (above copyright)', 'startbox' ),
						'footer_right'	=> __( 'Footer Right (above admin links)', 'startbox' ),
						'after_footer'	=> __( 'Bottom of Page', 'startbox' ),
					)),
					'depth_default' => 1,
					'extras'	=> false,
