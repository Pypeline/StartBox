 ...
 * @since 2.4.2
 */
$footer1 = ( is_sidebar_active( 'footer_widget_area_1' ) || has_action( 'no_footer_widget_area_1_widgets' ) );
$footer2 = ( is_sidebar_active( 'footer_widget_area_2' ) || has_action( 'no_footer_widget_area_2_widgets' ) );
$footer3 = ( is_sidebar_active( 'footer_widget_area_3' ) || has_action( 'no_footer_widget_area_3_widgets' ) );
$footer4 = ( is_sidebar_active( 'footer_widget_area_4' ) || has_action( 'no_footer_widget_area_4_widgets' ) );
